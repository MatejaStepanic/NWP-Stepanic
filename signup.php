...
<body>
	...
	if ($action == FALSE) {
		...
		<form action="" id="contact_form" name="contact_form" method="POST">
			...
			<br>
			<label for="username">Korisničko ime : * <small>(Minimalno 5 znakova, a maksimalno 10 znakova)</small></label>
			<input type="text" id="username" name="username" pattern=".{5,10}" placeholder="Korisničko ime ..." required>
			<br>
